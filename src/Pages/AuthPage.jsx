...
export const AuthPage = () => {
  ...
  const loginHandler = async () => {
    try {
      const data = await request('https://app-for-register.herokuapp.com/api/auth/test', 'POST', { ...form })
  ...
  const registerHandler = async () => {
    try {
      const data = await request('https://app-for-register.herokuapp.com/api/auth/register', 'POST', { ...form })
